...
import { FaAngleDown, FaShoppingCart, FaBars, FaTimes } from 'react-icons/fa';
import img1 from "./assets/navimg/custom-glove.png";
import img2 from "./assets/navimg/alloy-xp-homepage-bat-image.png"; // Original path retained
...
const NavBar = () => {
    ...
    return (
        <div className="bg-white shadow-md">
            <h3 className='bg-[#E5E5E5] font-bold lg:text-xl py-4 text-center'>
            ...
            <div className="container mx-auto mt-2 flex items-center justify-between py-5 relative">
                <Link to={'/'}>
                    <svg viewBox="0 0 146 44" fill="none" xmlns="http://www.w3.org/2000/svg" width="120">
                ...
                <div className='  lg:flex hidden gap-14 relative items-center'>
                    ...
                    <Link to={'/builder'}>
                        <button className='text-base transition duration-300 flex font-bold text-white bg-gray-700 px-2 py-2 rounded-md'>
                            <img src={wheel} alt="" /> Custom Builder
                        </button>
                    </Link>
                </div>
            ...
            {/* Mobile Menu */}
            {isMobileMenuOpen && (
                <div className="lg:hidden flex flex-col items-center bg-slate-100 shadow-md">
                    <button onClick={toggleDropdown} className='flex items-center gap-2 text-base hover:text-blue-600 transition duration-300'>
                        Custom Crafted
                        <FaAngleDown className={`transform transition-transform duration-300 ${isDropdownOpen ? 'rotate-180' : ''}`} />
                    </button>
                    {isDropdownOpen && (
                        <ul className='flex flex-col gap-2 p-4'>
                            <li>
                                <Link to="/custom-gloves" className='gap-4 flex flex-col items-center w-full py-2'>
                                    <img className='h-32 bg-white w-[180px] rounded-md hover:shadow-md transition transform hover:scale-105' src={img1} alt="Custom Gloves" />
                                    <span className='mt-2 text-center flex items-center justify-center text-sm font-bold'> <img src={wheel} alt="" /> Custom Gloves</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/custom-bats" className='gap-4 flex flex-col items-center w-full py-2'>
                                    <img className='h-32 bg-white w-[180px] rounded-md hover:shadow-md transition transform hover:scale-105' src={img2} alt="Custom Bats" />
                                    <span className='mt-2 text-center flex items-center justify-center text-sm font-bold'> <img src={wheel} alt="" /> Custom Bats</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/custom-batting-gloves" className='gap-4 flex flex-col items-center w-full py-2'>
                                    <img className='h-32 bg-white w-[180px] rounded-md hover:shadow-md transition transform hover:scale-105' src={img3} alt="Custom Batting Gloves" />
                                    <span className='mt-2 text-center flex items-center justify-center text-sm font-bold'> <img src={wheel} alt="" /> Custom Batting Gloves</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/custom-guards" className='gap-4 flex flex-col items-center w-full py-2'>
                                    <img className='h-32 bg-white w-[180px] rounded-md hover:shadow-md transition transform hover:scale-105' src={img4} alt="Custom Guards" />
                                    <span className='mt-2 text-center flex items-center justify-center text-sm font-bold'> <img src={wheel} alt="" /> Custom Guards</span>
                                </Link>
                            </li>
                        </ul>
